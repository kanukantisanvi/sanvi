...
public class TestStackQueue {
 ...
 stack.push("Chiru"); // Push Tom to the stack
 System.out.println("(1) " + stack);
 stack.push("Balayya"); // Push Susan to the the stack
 System.out.println("(2) " + stack);
 stack.push("Nag"); // Push it to the stack
 stack.push("Venki"); // Push Michael to the stack
